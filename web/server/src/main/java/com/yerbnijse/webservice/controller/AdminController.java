...
public class AdminController {
  ...
  public ResponseEntity<PagingResult> getUserList(
      ...
      @RequestParam(name = "chIn", required = false) String chIn,
  ...
  public ResponseEntity<Void> changeEmailFor(
      @PathVariable(name = "uId") Long userId, @RequestBody @Valid EmailInput input) {
  ...
  public ResponseEntity<Void> changePassword(
      @PathVariable(name = "uId") Long userId, @RequestBody @Valid PasswordChangeInput input) {
  ...
  public ResponseEntity<Void> changeRole(
      @PathVariable(name = "uId") Long userId, @RequestBody RoleChangeInput input) {
  ...
  public ResponseEntity<Void> createUser(
      @PathVariable(name = "role") Roles roles, @RequestBody @Valid RegisterInput input) {
  	adminService.registerUser(roles, input);
  	return ResponseEntity.ok().build();
	}
}
